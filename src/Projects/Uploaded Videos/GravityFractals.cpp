...
void render_2d() {
    ...
    // Move the planets into a regular pentagon
    {
        ...
        scene.state_manager.add_transitions(pentagon_transitions);
    }
...
void render_3d() {
    ...
    comp.state_manager.add_transitions(unordered_map<string, string>{
        {"planet1.opacity", "0.5"},
...
void render_credits() {
    ...
    cs.state_manager.add_equations(unordered_map<string, string>{
