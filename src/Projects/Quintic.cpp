...
void render_video(){
    ...
    */
    ...
    string pm_colored = "\\frac{-b "+latex_color(0xffff8080, "\\pm")+" \\sqrt{b^2 - 4ac}}{2a}";
    ...
    cs.stage_macroblock(FileBlock("So, creating a continuous function to track a particular root is an impossible task to begin with."), 2);
