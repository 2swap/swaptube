...
void beginning() {
    c4.inject_audio_and_render(AudioSegment("To recap my last few episodes of connect 4 strategy,"));
    c4.inject_audio_and_render(AudioSegment("we've learned that there are certain positions, like this one, for which there is a naive strategy which guarantees a player's ability to win."));
    ...
    c4.inject_audio_and_render(AudioSegment(" `"));
    c4.inject_audio_and_render(AudioSegment(""));
    c4.inject_audio_and_render(AudioSegment(""));
}
