...
UnresolvedStateEquationComponent::UnresolvedStateEquationComponent(const std::string& space_delimited_string) {
...
std::string UnresolvedStateEquationComponent::to_string() const {
    switch (type) {
...
UnresolvedStateEquation::UnresolvedStateEquation(const std::string& equation_string) {
...
std::list<std::string> UnresolvedStateEquation::get_local_dependencies() const {
...
std::string UnresolvedStateEquation::to_string() const {
