#include "MovingPendulumGridScene.h"

MovingPendulumGridScene::MovingPendulumGridScene(const vec2& dimensions) : CoordinateScene(dimensions) {
...
void MovingPendulumGridScene::draw() {
    draw_grid();
