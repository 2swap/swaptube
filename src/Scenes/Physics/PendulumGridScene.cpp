...
const StateQuery PendulumGridScene::populate_state_query() const {
...
void PendulumGridScene::draw() {
    draw_grid();
    draw_pendulum_trail();
    CoordinateScene::draw();
}

void PendulumGridScene::draw_pendulum_trail(){
