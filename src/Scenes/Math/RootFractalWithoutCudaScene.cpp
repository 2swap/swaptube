...
class RootFractalWithoutCudaScene : public CoordinateScene {
public:
    RootFractalWithoutCudaScene(const float width = 1, const float height = 1) : CoordinateScene(width, height) {
        ...
        state_manager.set("degree_fixed", "0");
    }
