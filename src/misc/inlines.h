...
inline double fifo_curve(double x, double seconds_so_far, double seconds_left){return min(1, max(max(1-fourth(2*x-1), transparency_profile(seconds_so_far/3)), transparency_profile(seconds_left/3)));} // fade in fade out
