...
void Pendulum::iterate_physics(int multiplier, pendulum_type step_size) {
...
) : w(width), h(height), delta(d), t1_min(t1_min), t1_max(t1_max), t2_min(t2_min), t2_max(t2_max), p1_min(p1_min), p1_max(p1_max), p2_min(p2_min), p2_max(p2_max), samples(0) {
...
void PendulumGrid::iterate_physics(int multiplier, pendulum_type step_size) {
